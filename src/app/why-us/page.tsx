  ...
  return (
    <LegalLayout title="Why SmartBusinessValue" lastUpdated="February 22, 2026">
      <section className="mb-12">
        ...
        <div className="bg-[#0c1a33] text-white p-8 rounded-3xl shadow-xl mb-12 border border-white/10">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-extrabold text-[#f2f6ff] mb-8 tracking-tight">Main Strategy Pillars</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
            <Zap className="w-10 h-10 text-accent mx-auto mb-4" />
            <h4 className="font-bold text-[#e8f1ff] mb-2">Longevity Over Speed</h4>
            <p className="text-[#9ab0d0] text-sm">
              AI makes building easy, but sustaining value over time is where legacy is built.
            </p>
          </div>
          <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
            <ShieldCheck className="w-10 h-10 text-accent mx-auto mb-4" />
            <h4 className="font-bold text-[#e8f1ff] mb-2">Focus on Core</h4>
            <p className="text-[#9ab0d0] text-sm">
              Businesses shouldn&apos;t waste time building internal tools. We handle the systems, you handle the growth.
            </p>
          </div>
          <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
            <Sparkles className="w-10 h-10 text-accent mx-auto mb-4" />
            <h4 className="font-bold text-[#e8f1ff] mb-2">Modern Value</h4>
            <p className="text-[#9ab0d0] text-sm">
              Existing solutions are costly & outdated. We deliver enterprise-grade tech on a cloud-native foundation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        <p className="text-[#b4c4de] leading-relaxed">
